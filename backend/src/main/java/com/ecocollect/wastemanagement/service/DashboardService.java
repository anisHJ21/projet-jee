...
public class DashboardService {
    ...
    public DashboardStatsResponse getDashboardStats() {
        List<com.ecocollect.wastemanagement.model.CollectionPoint> points = 
            collectionPointRepository.findAll();
        List<com.ecocollect.wastemanagement.model.Route> routes = 
            routeRepository.findAll();
        List<com.ecocollect.wastemanagement.model.Employee> employees = 
            employeeRepository.findAll();
        List<com.ecocollect.wastemanagement.model.Alert> alerts = 
        ...
        DashboardStatsResponse.CollectionPointsStats collectionPointsStats = 
            new DashboardStatsResponse.CollectionPointsStats(
                points.size(),
                (int) criticalPoints
            );
        ...
        DashboardStatsResponse.RoutesStats routesStats = 
            new DashboardStatsResponse.RoutesStats(
                routes.size(),
                (int) activeRoutes
            );
        ...
        DashboardStatsResponse.EmployeesStats employeesStats = 
            new DashboardStatsResponse.EmployeesStats(
                (int) onDutyEmployees,
        ...
        DashboardStatsResponse.AlertsStats alertsStats = 
            new DashboardStatsResponse.AlertsStats(
                (int) activeAlerts,
                (int) criticalAlerts
            );
